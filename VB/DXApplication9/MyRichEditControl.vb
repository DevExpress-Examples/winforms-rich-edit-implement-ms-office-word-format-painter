...
Namespace DXApplication9
	...
	Public Class MyMouseCursorCalculator
        ...
        Public Overrides Function Calculate(ByVal hitTestResult As RichEditHitTestResult, ByVal physicalPoint As Point) As DevExpress.XtraRichEdit.Utils.RichEditCursor
